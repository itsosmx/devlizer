                  ...
                  <CardContent className="p-0">
                    <div className="grid md:grid-cols-2 gap-6 items-center">
                      ...
                      <div className="relative overflow-hidden">
                        <motion.div
                          className="aspect-video bg-gradient-to-br from-primary/20 to-accent/20 rounded-lg m-6 flex items-center justify-center overflow-hidden"
                            ...
                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                              <Button asChild size="lg" className="group">
                                <Link
                                  ...
                                  onClick={() => analytics.projectView(project.title, project.live || "")}>
          ...
          <motion.div
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} style={{ transformStyle: "preserve-3d" }}>
              <Button asChild size="lg" className="text-lg px-8 py-6 shadow-2xl hover:shadow-3xl transition-all duration-300">
                <Link href="/contact" onClick={() => analytics.ctaClick("start_project", "portfolio_cta", "/contact")}>
                  <span className="flex items-center">
                    {t("cta.button")}
                    <motion.div
                      animate={{ x: [0, 5, 0] }}
