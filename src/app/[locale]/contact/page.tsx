    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/30 overflow-x-hidden">
                  ...
                  {isSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select name="budget">
                          <SelectTrigger className="w-full">
                            <SelectValue placeholder={t("form.budget.select")} />
                          </SelectTrigger>
                          <SelectContent>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="hearAbout">{t("form.fields.hearAbout")}</Label>
      ...
      <section className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="space-y-8 grid md:grid-cols-3 lg:grid-cols-3 gap-8 md:gap-12 lg:gap-16">
